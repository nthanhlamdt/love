  ...
  return (
    <div>
      <div className='flex items-center justify-between'>
        ...
        <input type="date" className="px-2 py-1 text-pink-600 outline-pink-600 border-pink-500 border rounded-md" />
      </div>

      <div className="overflow-hidden h-40 border px-3 py-2 rounded-md mt-5 bg-pink-100 min-w-96 flex flex-col items-end">
