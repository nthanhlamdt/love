...
const HeartCanvas = ({ user, loveUser }) => {
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      wrapText(`${loveUser.fullName}`, rightX, y, 120, 30)
      ...
      context.textAlign = 'center'
      context.textBaseline = 'middle'
      context.fillText(`${CountingLoveDays(loveUser.loveDate)}`, canvas.width / 2, canvas.height / 2 + 30)
      ...
      if (avatar2.complete) {
        ...
        context.textAlign = 'center'
        context.textBaseline = 'top'
        context.fillText(`${formatDate(loveUser.dateBirth)}`, canvas.width / 2 + 110 + avatarSize / 2, canvas.height / 2 + 140 + avatarSize + 10)
        context.fillText(`${loveUser.gender === 'Nam'? '♂' : '♀'} ${getZodiacSign(loveUser.dateBirth)}`, canvas.width / 2 + 110 + avatarSize / 2, canvas.height / 2 + 140 + avatarSize + 30)
      }
    }
