export default function HeaderAlbum() {
  return (
    <div
      className="z-10 hero bg-cover bg-center h-96 flex items-center justify-center relative bg-[url('/assets/album.jpg')]"
    >
      <div className="absolute inset-0 bg-pink-500 bg-opacity-50"></div>
      <div className="text-center text-white relative z-10 p-1">
